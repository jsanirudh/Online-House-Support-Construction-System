			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					...
					<div class="card-body">
						...
						<form class="form-signin" action="regback2.jsp">
							...
							<input type="password" class="form-control mb-2"
								...
								autofocus> <input type="text" class="form-control mb-2"
								placeholder="Mobile" name="mobile" pattern="[0-9]{10}" required
								autofocus> <input type="text" class="form-control mb-2"
								placeholder="Address" name="addr" required autofocus>
