	...
	<div class="wrapper row1">
        ...
        <ul>
          ...
          <li><a href="#">Level 2</a></li>
				...
				<li><a class="active" href="vasthuhome.jsp">Home</a></li>
				<li><a class="active" href="userqueries.jsp">View User Queries</a></li>
				<li><a class="active" href="userresponse.jsp">View User Response</a></li>
		...
		<div class="row justify-content-sm-center">
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					<div class="card-header">Vastu reply</div>
					<div class="card-body">
						<!-- <img src="images/sam.jpg"> -->
						<!-- <h4 class="text-center">Hunger & Debt Ltd</h4> -->
						<form class="form-signin" action="vasthuaction1.jsp">
							<input type="text" class="form-control mb-2"
								placeholder="Response" name="res" required autofocus>
								<input type="hidden" class="form-control mb-2"
								placeholder="Response" name="id" value=<%=id%> required autofocus>
							<button class="btn btn-lg btn-primary btn-block mb-1"
								type="submit">Response</button>
