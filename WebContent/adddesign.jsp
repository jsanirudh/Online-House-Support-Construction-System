...
<body>
	<%
		String s1 = request.getParameter("dename");
		...
		try {
			...
			con = DriverManager.getConnection(
					...
					"root");
			pst = con
					.prepareStatement("insert into design(name,cost,image,dname) values(?,?,?,?)");
			pst.setString(1, s1);
			pst.setString(2, s3);
			...
			pst.executeUpdate();
			response.sendRedirect("vieww21.jsp?msg=your Equeipment Added successfully");
		} catch (Exception e) {
			e.printStackTrace();
		}
	%>
