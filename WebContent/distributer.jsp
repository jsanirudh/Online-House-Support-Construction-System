	...
	<div class="wrapper row1">
        ...
        <ul>
          ...
          <li><a href="#">Level 2</a></li>
				...
				<li><a href="vaasthu.jsp"">Vaastu</a></li>
			</ul>
		</nav>
	</div>
		...
		<div class="row justify-content-sm-center">
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					<div class="card-header">Distributor Login</div>
					<div class="card-body">
						<!-- <img src="images/sam.jpg"> -->
						<!-- <h4 class="text-center">Hunger & Debt Ltd</h4> -->
						<form class="form-signin" action="distributor1.jsp">
							<input type="text" class="form-control mb-2" placeholder="username" name ="uname"
								required autofocus> <input type="password"
								class="form-control mb-2" placeholder="password" name="pwd" required>
							<button class="btn btn-lg btn-primary btn-block mb-1"
								type="submit">Sign in</button>
								<br>
								<a href="reg2.jsp">New registration </a>
