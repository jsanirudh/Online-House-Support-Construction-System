			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					...
					<div class="card-body">
						...
						<form class="form-signin" action="ureg1.jsp">
							<input type="text" class="form-control mb-2" placeholder="Username" name ="uname" id="uname"
								required autofocus>
								
								 <input type="password"
								class="form-control mb-2" placeholder="Password" name="pwd" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
								title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
								 required>
								<input type="text" class="form-control mb-2" placeholder="Email" name ="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" 
								required autofocus>
								<input type="text" class="form-control mb-2" placeholder="Mobile" name ="mobile" pattern="[0-9]{10}" 
								required autofocus>
