...
<body>
<%
String s1 =request.getParameter("phase");
...
Class.forName("com.mysql.jdbc.Driver");
	 con=DriverManager.getConnection("jdbc:mysql://localhost:3306/constructt", "root", "root");
		 pst=con.prepareStatement("insert into rent(upload,phase,rent,loc) values(?,?,?,?)");
		 pst.setBinaryStream(1, (InputStream) fis1, (int) (f1.length()));
		 pst.setString(2,s1);
pst.setString(3,s2);
pst.setString(4,s3);
...
pst.executeUpdate();
response.sendRedirect("view4.jsp?msg=your applicaton filled successfully");
}
catch(Exception e)
{
	e.printStackTrace();
