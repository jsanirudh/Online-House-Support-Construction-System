		...
		<div class="row justify-content-sm-center">
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					<div class="card-header">Add house loan details</div>
					<div class="card-body">
						<!-- <img src="images/sam.jpg"> -->
						<!-- <h4 class="text-center">Hunger & Debt Ltd</h4> -->
						<form class="form-signin" action="house1.jsp">
							<input type="text" class="form-control mb-2" placeholder="House name" name ="hname"
								required autofocus> 
								<input type="text"
								class="form-control mb-2" placeholder="Loan Amount" name="lamount" required>
								<input type="text" class="form-control mb-2" placeholder="Duration of time" name ="dtime"
								required autofocus> 
								<input type="text"
								class="form-control mb-2" placeholder="house address" name="hadd" required>
