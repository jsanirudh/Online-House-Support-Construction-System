        ...
        <ul>
          ...
          <li><a href="#">Level 2</a></li>
				...
				<li><a href="distributer.jsp">Distributor</a></li>
				  ...
				  <li><a href="vaasthu.jsp"">Queries</a></li>
			</ul>
		</nav>
	</div>
		...
		<div class="row justify-content-sm-center">
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					<div class="card-header">Queries Login</div>
					<div class="card-body">
						<!-- <img src="images/sam.jpg"> -->
						<!-- <h4 class="text-center">Hunger & Debt Ltd</h4> -->
						<form class="form-signin" action="vasthuaction.jsp">
							<input type="text" class="form-control mb-2" placeholder="Username" name ="username"
								required autofocus> <input type="password"
								class="form-control mb-2" placeholder="Password" name="pass" required>
