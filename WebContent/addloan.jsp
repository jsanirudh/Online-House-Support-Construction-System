		...
		<div class="row justify-content-sm-center">
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					<div class="card-header">Add Loans</div>
					<div class="card-body">
						<!-- <img src="images/sam.jpg"> -->
						<!-- <h4 class="text-center">Hunger & Debt Ltd</h4> -->
						<form class="form-signin" action="addloan1.jsp">
								<input type="text" class="form-control mb-2"
								placeholder="Home Name" name="hname" required autofocus>
								<input type="text" class="form-control mb-2"
								placeholder="Loan Amount" name="amount" required autofocus>
								<input type="text" class="form-control mb-2"
								placeholder="Duration Time" name="durtime" required autofocus>
							
								<input type="text" class="form-control mb-2"
								placeholder="house Address" name="address" required autofocus>
								
									<input type="text" class="form-control mb-2"
								placeholder="Bank" name="bank" required autofocus>
