		...
		<div class="row justify-content-sm-center">
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					<div class="card-header">Add Distributer</div>
					<div class="card-body">
						<!-- <img src="images/sam.jpg"> -->
						<!-- <h4 class="text-center">Hunger & Debt Ltd</h4> -->
						<form class="form-signin" action="distaction.jsp">
							<input type="text" class="form-control mb-2"
								placeholder="Distributer Name" name="bname" required autofocus>
								<input type="text" class="form-control mb-2"
								placeholder="Distributer Mobile" name="bmobile" required autofocus>
								<input type="text" class="form-control mb-2"
								placeholder="Distributer Address" name="baddr" required autofocus>
