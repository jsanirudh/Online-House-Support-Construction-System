		...
		<div class="row justify-content-sm-center">
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					<div class="card-header">Add Architect</div>
					<div class="card-body">
						<!-- <img src="images/sam.jpg"> -->
						<!-- <h4 class="text-center">Hunger & Debt Ltd</h4> -->
						<form class="form-signin" action="engaction.jsp">
							<input type="text" class="form-control mb-2"
								placeholder="Engineer Name" name="bname" required autofocus>
								<input type="text" class="form-control mb-2"
								placeholder="Engineer Mobile" name="bmobile" required autofocus>
								<input type="text" class="form-control mb-2"
								placeholder="Engineer Address" name="baddr" required autofocus>
