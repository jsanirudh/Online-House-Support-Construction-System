	...
	<div class="wrapper row1">
		...
		<nav id="mainav" class="hoc clear">
			<ul class="clear">
				...
				<li><a class="active" href="addequ.jsp">Add Materials</a></li>
			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					...
					<div class="card-body">
						...
						<form class="form-signin" action="addequ.jsp">
							<!-- <input type="text" class="form-control mb-2"
								placeholder="Desgin Name" name="dename" required autofocus> -->
							<select class="form-control mb-2" name="dename" required autofocus>
								<option value="">Select....</option>
								<option value="Bricks">Bricks</option>
								<option value="Cement">Cement</option>
								<option value="Toolss">Tools</option>
								<option value="Wires">Wires</option>
							</select> <input type="text" class="form-control mb-2"
								placeholder="Material Cost" name="cost" required autofocus>
