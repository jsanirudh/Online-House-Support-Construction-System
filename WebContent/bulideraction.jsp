...
Class.forName("com.mysql.jdbc.Driver");
	 con=DriverManager.getConnection("jdbc:mysql://localhost:3306/constructt", "root", "root");
		 pst=con.prepareStatement("insert into builder(bname,bmobile,baddr,upload) values(?,?,?,?)");
		 pst.setString(1,s1);
pst.setString(2,s2);
pst.setString(3,s3);
...
pst.executeUpdate();
response.sendRedirect("addbuilder.jsp?msg=your applicaton filled successfully");
}
catch(Exception e)
{
	e.printStackTrace();
