...
<body>
	<%
		...
		String upload = request.getParameter("image");
		...
		try {
			...
			pst = con.prepareStatement("insert into eque(name,description,cost,image) values(?,?,?,?)");
			pst.setString(1, s1);
			pst.setString(2, s2);
			pst.setString(3, s3);
			...
			pst.executeUpdate();
			response.sendRedirect("addequ.jsp?msg=your Equeipment Added successfully");
		} catch (Exception e) {
			e.printStackTrace();
		}
	%>
