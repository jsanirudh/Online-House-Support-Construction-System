			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					...
					<div class="card-body">
						...
						<form class="form-signin" action="adddesign.jsp">
							...
							<select class="form-control mb-2" name="dename" required autofocus>
								...
								<option value="Flats">Modern</option>
								<option value="Normal Houses">Normal Houses</option>
							</select> <input type="text" class="form-control mb-2"
								placeholder="Desgin Cost" name="cost" required autofocus>
