			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="card border-info text-center">
					...
					<div class="card-body">
						...
						<form class="form-signin" action="bulideraction.jsp">
							<input type="text" class="form-control mb-2"
								placeholder="Contractor Name" name="bname" required autofocus>
								<input type="text" class="form-control mb-2"
								placeholder="Contractor Mobile" name="bmobile" required autofocus>
								<input type="text" class="form-control mb-2"
								placeholder="Contractor Address" name="baddr" required autofocus>
